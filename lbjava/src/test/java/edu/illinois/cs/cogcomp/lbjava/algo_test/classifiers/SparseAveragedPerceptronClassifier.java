...
public class SparseAveragedPerceptronClassifier extends SparseAveragedPerceptron
{
  private static void loadInstance()
  {
    if (instance == null) instance = new SparseAveragedPerceptronClassifier(true);
  }
  ...
  public static SparseAveragedPerceptronClassifier instance;

  public static SparseAveragedPerceptronClassifier getInstance()
  {
    loadInstance();
    return instance;
  }

  private SparseAveragedPerceptronClassifier(boolean b)
  {
    super(new Parameters());
    containingPackage = "";
    name = "SparseAveragedPerceptronClassifier";
    setEncoding(null);
  ...
  public SparseAveragedPerceptronClassifier()
  {
    super("SparseAveragedPerceptronClassifier");
    isClone = true;
  }

	public SparseAveragedPerceptronClassifier(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

	public SparseAveragedPerceptronClassifier(Parameters p, String modelPath, String lexiconPath) {
		super(p);
		try {
		...
		else if (IOUtilities.existsInClasspath(SparseAveragedPerceptronClassifier.class, modelPath)) {
			readModel(IOUtilities.loadFromClasspath(SparseAveragedPerceptronClassifier.class, modelPath));
			readLexiconOnDemand(IOUtilities.loadFromClasspath(SparseAveragedPerceptronClassifier.class, lexiconPath));
		}
		else {
			containingPackage = "";
			name = "SparseAveragedPerceptronClassifier";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof AlgoData || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'SparseAveragedPerceptronClassifier(AlgoData)' defined on line 32 of CL.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: SparseAveragedPerceptronClassifier \\");
    ...
    SparseAveragedPerceptronClassifier classifier = new SparseAveragedPerceptronClassifier();
  ...
  public int hashCode() { return "SparseAveragedPerceptronClassifier".hashCode(); }
  public boolean equals(Object o) { return o instanceof SparseAveragedPerceptronClassifier; }
