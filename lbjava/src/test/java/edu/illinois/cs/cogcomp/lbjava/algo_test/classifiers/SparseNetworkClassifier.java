...
public class SparseNetworkClassifier extends SparseNetworkLearner
{
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof AlgoData || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'SparseNetworkClassifier(AlgoData)' defined on line 39 of CL.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: SparseNetworkClassifier \\");
