...
public class NewsMLPClassifier extends MultiLayerPerceptron
{
  private static void loadInstance()
  {
    if (instance == null) instance = new NewsMLPClassifier(true);
  }
  ...
  public static NewsMLPClassifier instance;

  public static NewsMLPClassifier getInstance()
  {
    loadInstance();
    return instance;
  }

  private NewsMLPClassifier(boolean b)
  {
    super(new Parameters());
    containingPackage = "edu.illinois.cs.cogcomp.lbjava.examples.news";
    name = "NewsMLPClassifier";
    setEncoding(null);
    setLabeler(new NewsgroupLabel());
  ...
  public NewsMLPClassifier()
  {
    super("edu.illinois.cs.cogcomp.lbjava.examples.news.NewsMLPClassifier");
    isClone = true;
  }

	public NewsMLPClassifier(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

	public NewsMLPClassifier(Parameters p, String modelPath, String lexiconPath) {
		super(p);
		try {
		...
		else if (IOUtilities.existsInClasspath(NewsMLPClassifier.class, modelPath)) {
			readModel(IOUtilities.loadFromClasspath(NewsMLPClassifier.class, modelPath));
			readLexiconOnDemand(IOUtilities.loadFromClasspath(NewsMLPClassifier.class, lexiconPath));
		}
		else {
			containingPackage = "edu.illinois.cs.cogcomp.lbjava.examples.news";
			name = "NewsMLPClassifier";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof Post || example instanceof Object[]))
      {
        String type = example == null ? "null" : example.getClass().getName();
        System.err.println("Classifier 'NewsMLPClassifier(Post)' defined on line 22 of news.lbj received '" + type + "' as input.");
  ...
  public void learn(Object[] examples)
  {
    if (isClone)
    {
      if (!(examples instanceof Post[] || examples instanceof Object[][]))
      {
  ...
  public Feature featureValue(Object __example)
  {
    if (isClone)
    {
      if (!(__example instanceof Post || __example instanceof Object[]))
      {
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: edu.illinois.cs.cogcomp.lbjava.examples.news.NewsMLPClassifier \\");
    ...
    NewsMLPClassifier classifier = new NewsMLPClassifier();
  ...
  public int hashCode() { return "NewsMLPClassifier".hashCode(); }
  public boolean equals(Object o) { return o instanceof NewsMLPClassifier; }
  ...
  public void setParameters(edu.illinois.cs.cogcomp.lbjava.learn.MultiLayerPerceptron.Parameters a0)
  {
    if (isClone)
    {
      loadInstance();
  ...
  public static class Parameters extends MultiLayerPerceptron.Parameters
  {
    public Parameters()
    {
