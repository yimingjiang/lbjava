...
public class SparseNetworkClassifier extends SparseNetworkLearner
{
  private static void loadInstance()
  {
    if (instance == null) instance = new SparseNetworkClassifier(true);
  }
  ...
  public static SparseNetworkClassifier instance;

  public static SparseNetworkClassifier getInstance()
  {
    loadInstance();
    return instance;
  }

  private SparseNetworkClassifier(boolean b)
  {
    super(new Parameters());
    containingPackage = "edu.illinois.cs.cogcomp.lbjava.examples.news";
    name = "SparseNetworkClassifier";
    setEncoding(null);
  ...
  public SparseNetworkClassifier()
  {
    super("edu.illinois.cs.cogcomp.lbjava.examples.news.SparseNetworkClassifier");
    isClone = true;
  }

	public SparseNetworkClassifier(String modelPath, String lexiconPath) { this(new Parameters(), modelPath, lexiconPath); }

	public SparseNetworkClassifier(Parameters p, String modelPath, String lexiconPath) {
		super(p);
		try {
		...
		else if (IOUtilities.existsInClasspath(SparseNetworkClassifier.class, modelPath)) {
			readModel(IOUtilities.loadFromClasspath(SparseNetworkClassifier.class, modelPath));
			readLexiconOnDemand(IOUtilities.loadFromClasspath(SparseNetworkClassifier.class, lexiconPath));
		}
		else {
			containingPackage = "edu.illinois.cs.cogcomp.lbjava.examples.news";
			name = "SparseNetworkClassifier";
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof Post || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'SparseNetworkClassifier(Post)' defined on line 22 of news.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: edu.illinois.cs.cogcomp.lbjava.examples.news.SparseNetworkClassifier \\");
    ...
    SparseNetworkClassifier classifier = new SparseNetworkClassifier();
  ...
  public int hashCode() { return "SparseNetworkClassifier".hashCode(); }
  public boolean equals(Object o) { return o instanceof SparseNetworkClassifier; }
